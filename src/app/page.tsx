                ...
                <div className="grid gap-4 md:gap-6 md:grid-cols-12 min-h-[340px]">
                  ...
                  <div className="md:col-span-4 flex flex-col gap-2.5">
                    ...
                    {['e-Puantaj', 'e-İK', 'e-Talep', 'e-Evrak', 'e-Finans'].map((item, index) => (
                      <div
                        key={item}
                        className={`rounded-2xl px-5 py-3.5 text-[13.5px] font-bold transition-colors ${
                          index === 0 ? 'bg-[#ef5a28] text-white shadow-lg shadow-[#ef5a28]/20' : 'bg-[#2a2a2a] text-[#888] hover:bg-[#333]'
                        }`}
                      >
                        {item}
                      </div>
