...
export default function Sidebar({ isOpen }: SidebarProps) {
  ...
  const { pendingCounts } = useNotifications();
  ...
  const badgeMap: Record<string, number> = {
    "Gelen Talepler": (pendingCounts["sgk-giris"] || 0) + (pendingCounts["sgk-cikis"] || 0),
    "SGK Giriş Talebi": pendingCounts["sgk-giris"] || 0,
    "SGK Çıkış Talebi": pendingCounts["sgk-cikis"] || 0,
